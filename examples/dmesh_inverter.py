...
parser.add_argument('--file_name', type=str, default='./images/car-example.png')
...
target = image.read(args.file_name, as_transformed_tensor=True, im_size=512,
...
fn = args.model_file.split('/')[-1].split('.')[0]
save_dir = f'./results/stylegan2_cars/basincma_{fn}'
